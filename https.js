...
// - You’re using Node.js’s File System (fs) module.
// - appendFile means: take the string in log and add it to the file requests.txt.
// - If the file doesn’t exist, Node will create it.
// - If it exists, Node will add the new log entry at the end.
// - This is asynchronous (non-blocking). The callback (err, data) => { ... } runs only after the file operation completes.
// 👉 So you’re logging each request into a file called requests.txt
...
//   log is just the message or data you want to record about each request
